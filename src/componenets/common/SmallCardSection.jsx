...
const SmallCardSection = () => {
    return (
        <div>
            <div className=' flex w-[80%] mx-auto  gap-4 justify-around items-center py-9 my-10'>
                <div className=' flex border border-blue-700 w-[35%] h-32 rounded-2xl justify-between items-center '>
                ...
                <div className=' flex border border-blue-500 w-[35%] h-32 rounded-2xl justify-between items-center '>
